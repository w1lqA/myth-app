...
<div className='bg-main max-w-screen-3xl mx-auto sm:pb-48 pb-64 relative z-20'>
    <div className='relative flex justify-center items-center max-w-screen-xl mx-auto'>
        ...
        <div className='absolute z-40 flex md:hidden'>
            <div className='lg:scale-100 scale-[85%] sm:translate-y-48 translate-y-64 relative overflow-hidden flex items-center justify-center max-w-screen-lg animate-in duration-1000 fade-in zoom-in-50'>
                <img 
                    src={DescriptionBG} 
        ...
        <div 
            ...
            <img draggable={false} src={LeftComposition} 
            ...
            <img draggable={false} src={RightComposition} 
                className='absolute inset-0 self-end justify-self-end -translate-y-10 
                lg:w-96 w-72'/>
            <img draggable={false} src={BottomRightComposition} 
                className='absolute inset-0 self-end justify-self-end 
                lg:w-96 w-72'/>
            
            <div className='animate-in duration-1000 fade-in zoom-in-50 opacity-0 md:opacity-100 lg:scale-100 scale-[85%] relative overflow-hidden flex items-center justify-center max-w-screen-lg'>
                <img 
                    src={DescriptionBG} 
                    className=" absolute inset-0 w-full object-contain"
                />
